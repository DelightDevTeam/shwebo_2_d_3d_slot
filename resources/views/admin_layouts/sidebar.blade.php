    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a data-bs-toggle="collapse" href="#dashboardsExamples" class="nav-link text-white "
                ...
                <span class="nav-link-text ms-2 ps-1">Tools</span>
            </a>
                                    ...
                                    @can('admin_access')
                                        <li class="nav-item">
                                            <a class="nav-link text-white "
                                                href="{{ route('admin.internet-2d-digits.index') }}">
                                                <span class="sidenav-mini-icon"> 2D </span>
        ...
        @can('three_d_access')
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#three_d" class="nav-link text-white" aria-controls="pagesExamples"
                            ...
                            <div class="collapse " id="three_d">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    @can('admin_access')
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-white " href="{{ url('admin/3d-one-week-records') }}">
                                                <span class="sidenav-mini-icon">3D</span>
                                                <span class="sidenav-normal  ms-2  ps-1">တစ်ပတ်မှတ်တမ်း</span>
                                            </a>
                                        </li>
                                    @endcan
                                    ...
                                    @can('three_d_agent_histroy')
                                        <li class="nav-item">
                                            <a class="nav-link text-white "
                                                href="{{ url('admin/3d-agent-one-week-records') }}">
                                                <span class="sidenav-mini-icon">3D</span>
                                                <span class="sidenav-normal  ms-2  ps-1">တစ်ပတ်မှတ်တမ်း</span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-white "
                                                href="{{ url('admin/3d-agent-all-first-winner') }}">
                                                <span class="sidenav-mini-icon">3D</span>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-white " href="{{ url('admin/3d-agent-second-winner') }}">
                                                <span class="sidenav-mini-icon">3D</span>
                                                <span class="sidenav-normal  ms-2  ps-1">ပတ်လည်ပေါက်-မှတ်တမ်း</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link text-white " href="{{ url('admin/3d-agent-third-winner') }}">
                                                <span class="sidenav-mini-icon">3D</span>
                                                <span class="sidenav-normal  ms-2  ps-1">သွဒ်ပေါက်-မှတ်တမ်း</span>
                                            </a>
                                        </li>
                                    @endcan
                                </ul>
        ...
        @can('two_d_access')
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#profileExample1" class="nav-link text-white"
                    aria-controls="pagesExample1" role="button" aria-expanded="false">
                    <i class="material-icons-round {% if page.brand == 'RTL' %}ms-2{% else %} me-2{% endif %}">settings</i>
                    <span class="nav-link-text ms-2 ps-1">2D Log</span>
                </a>
                <div class="collapse show" id="pagesExample1">
                    <ul class="nav">
                        <li class="nav-item ">
                            <div class="collapse " id="profileExample1">
                                <ul class="nav nav-sm flex-column">
                                    @can('admin_acess')
                                        <li class="nav-item">
                                    ...
                                    @can('two_d_history')
                                        <li class="nav-item">
                                            <a class="nav-link text-white "
                                                href="{{ url('admin/2d-agent-morning-history') }}">
                                                <span class="sidenav-mini-icon"> 2D </span>
                                                <span class="sidenav-normal  ms-2  ps-1"> 12:1-မှတ်တမ်း </span>
                                            </a>
                                        </li>
                                    ...
                                    @can('two_d_agent_slip_access')
                                        <li class="nav-item ">
                                            <a class="nav-link text-white "
                                                href="{{ url('admin/2d-agentmorning-all-slip') }}">
                                                <span class="sidenav-mini-icon"> 2D </span>
                                    ...
                                    @can('morning_win')
                                        <li class="nav-item">
                                            <a class="nav-link text-white "
                                                href="{{ url('admin/2-d-agent-morning-winner') }}">
                                                <span class="sidenav-mini-icon"> 2D </span>
                                                <span class="sidenav-normal  ms-2  ps-1"> 12:1-ပေါက်သူများ </span>
                                            </a>
                                        </li>
                                    ...
                                    @can('two_d_history')
                                        <li class="nav-item">
                                            <a class="nav-link text-white "
                                                href="{{ url('admin/2d-agent-evening-history') }}">
                                                <span class="sidenav-mini-icon"> 2D </span>
                                    ...
                                    @can('two_d_agent_slip_access')
                                        ...
                                        <li class="nav-item ">
                                            <a class="nav-link text-white "
                                                href="{{ url('admin/2d-agent-evening-all-slip') }}">
                                                <span class="sidenav-mini-icon"> 2D </span>
                                                <span class="sidenav-normal  ms-2  ps-1"> (4:30) AllSlip မှတ်တမ်း </span>
                                            </a>
                                        </li>
                                    ...
                                    @can('evening_win')
                                        <li class="nav-item">
                                            <a class="nav-link text-white "
                                                href="{{ url('admin/2-d-agent-evening-winner') }}">
                                                <span class="sidenav-mini-icon"> 2D </span>
                                                <span class="sidenav-normal  ms-2  ps-1"> 4:30-ပေါက်သူများ </span>
                                            </a>
                                        </li>
        ...
        @can('three_d_access')
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#three_d1" class="nav-link text-white" aria-controls="pagesExample2"
                    role="button" aria-expanded="false">
                    <i class="material-icons-round {% if page.brand == 'RTL' %}ms-2{% else %} me-2{% endif %}">settings</i>
                    <span class="nav-link-text ms-2 ps-1">3D Log</span>
                </a>
                <div class="collapse show" id="pagesExample2">
                    <ul class="nav">
                        <li class="nav-item ">
                            <div class="collapse " id="three_d1">
                                <ul class="nav nav-sm flex-column">
                                    @can('admin_access')
                                        <li class="nav-item">
                                            <a class="nav-link text-white " href="{{ url('admin/3d-one-week-records') }}">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-white " href="{{ url('admin/3d-one-week-slip') }}">
                                                <span class="sidenav-mini-icon">3D</span>
                                                <span class="sidenav-normal  ms-2  ps-1">တစ်ပတ်အတွင်း Slip</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-white " href="{{ url('admin/3d-second-prize') }}">
                                                <span class="sidenav-mini-icon">3D</span>
                                                <span class="sidenav-normal  ms-2  ps-1">ပတ်လည်ပေါက်</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-white " href="{{ url('admin/3d-third-prize') }}">
                                                <span class="sidenav-mini-icon">3D</span>
                                                <span class="sidenav-normal  ms-2  ps-1">တွဒ်ပေါက်</span>
                                            </a>
                                        </li>
                                    @endcan
